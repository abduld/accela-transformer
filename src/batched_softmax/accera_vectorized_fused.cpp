...
/// [import-hat]
#include "vectorized_fused.hat"
/// [import-hat]

static void BENCHMARK_NAME(Accera_Vectorized_Fused)(benchmark::State& state) {
  /// [declare-io]
...
ADD_BENCHMARK(BENCHMARK_NAME(Accera_Vectorized_Fused));
